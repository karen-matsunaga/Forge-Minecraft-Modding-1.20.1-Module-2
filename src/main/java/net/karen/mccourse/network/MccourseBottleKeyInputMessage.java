...
public class MccourseBottleKeyInputMessage {
    ...
    public static void buffer(MccourseBottleKeyInputMessage msg, FriendlyByteBuf buf) { buf.writeBoolean(msg.storeAll); }
    ...
    public static void handler(MccourseBottleKeyInputMessage msg, Supplier<NetworkEvent.Context> ctx) {
        ...
        context.enqueueWork(() -> {
            ...
            if (player != null) {
                ...
                if (toStore > 0 && storedLevels < maxLevels) {
                    ...
                    MccourseBottleItem.screen(player, "XP full or insufficient.", ChatFormatting.RED);
                }
            }
        });
    }
