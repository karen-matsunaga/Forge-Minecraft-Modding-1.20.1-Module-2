...
public class WalnutTrunkPlacer extends TrunkPlacer {
    ...
    public WalnutTrunkPlacer(int pBaseHeight, int pHeightRandA, int pHeightRandB) { super(pBaseHeight, pHeightRandA, pHeightRandB); }

    @Override
    protected TrunkPlacerType<?> type() { return ModTrunkPlacerTypes.WALNUT_TRUNK_PLACER.get(); }
