...
public class ModBiomes {
    ...
    public static Biome testBiome(BootstapContext<Biome> context) {
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ModPlacedFeatures.WALNUT_PLACED_KEY); // All features and custom features added

        return new Biome.BiomeBuilder() // Customize rain, sky, special effects, etc.
    ...
    // Register all custom biomes on .JSON file
    public static ResourceKey<Biome> register(String name) { return ResourceKey.create(Registries.BIOME, new ResourceLocation(MCCourseMod.MOD_ID, name)); }
}