package net.karen.mccourse.worldgen.biome.surface;
...
public class ModSurfaceRules {
    ...
    private static SurfaceRules.RuleSource makeStateRule(Block block) { return SurfaceRules.state(block.defaultBlockState()); }
}