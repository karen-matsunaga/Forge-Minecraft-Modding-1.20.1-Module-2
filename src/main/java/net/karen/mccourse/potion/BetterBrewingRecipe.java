...
/* BetterBrewingRecipe Class by CAS-ual-TY from https://github.com/CAS-ual-TY/Extra-Potions
   (GPL-3.0 License) - https://github.com/CAS-ual-TY/Extra-Potions/blob/main/LICENSE */
public class BetterBrewingRecipe implements IBrewingRecipe {
    ...
    @Override
    public boolean isInput(@NotNull ItemStack input) { return PotionUtils.getPotion(input) == this.input; }
