...
import net.karen.mccourse.entity.animations.ModAnimationDefinitions;
...
public class RhinoModel<T extends RhinoEntity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() { // Rhino's body layer model
	...
	public void setupAnim(RhinoEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animate(entity.idleAnimationState, ModAnimationDefinitions.RHINO_IDLE, ageInTicks, 1f); // Rhino's walk animation
		this.animate(entity.attackAnimationState, ModAnimationDefinitions.RHINO_ATTACK, ageInTicks, 1f); // Rhino's attack animation
		this.animate(entity.attackAnimationState, ModAnimationDefinitions.RHINO_SIT, ageInTicks, 1f); // Rhino's sit animation
	}
	...
	@Override
	public ModelPart root() { return rhino; }
}