...
public class EnchantedRecipeBuilder implements RecipeBuilder {
    ...
    public EnchantedRecipeBuilder(ItemLike ingredient, Item result, int count) {
    ...
    // WRITE Enchanted JSON custom recipes
    public static class Result implements FinishedRecipe {
        ...
        public ResourceLocation getId() {
            return new ResourceLocation(MCCourseMod.MOD_ID,
                    ForgeRegistries.ITEMS.getKey(this.result).getPath() + "_from_enchanted");
        }

        @Override
        public RecipeSerializer<?> getType() { return EnchantedRecipe.Serializer.INSTANCE; }
