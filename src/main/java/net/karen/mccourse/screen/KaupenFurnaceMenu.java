...
public class KaupenFurnaceMenu extends AbstractFurnaceMenu {
    protected KaupenFurnaceMenu(int pContainerId, Inventory pPlayerInventory, FriendlyByteBuf friendlyByteBuf) { this(pContainerId, pPlayerInventory); }
    ...
    @Override
    protected boolean isFuel(ItemStack pStack) { return true; }
}