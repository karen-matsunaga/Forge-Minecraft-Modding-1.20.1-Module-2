...
public class AddSusSandItemModifier extends LootModifier {
    ...
    public AddSusSandItemModifier(LootItemCondition[] conditionsIn, Item item) { super(conditionsIn); this.item = item; }
    ...
    protected @NotNull ObjectArrayList<ItemStack> doApply(ObjectArrayList<ItemStack> generatedLoot, LootContext context) {
        ...
        if(context.getRandom().nextFloat() < 0.50f) { // THIS IS WAY TOO HIGH. Suggest something like 0.11f ish
            generatedLoot.clear();
