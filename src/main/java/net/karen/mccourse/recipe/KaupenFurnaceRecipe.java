...
public class KaupenFurnaceRecipe extends AbstractCookingRecipe {
    ...
    @Override
    public ItemStack getToastSymbol() { return new ItemStack(ModBlocks.KAUPEN_FURNACE_BLOCK.get()); }
    ...
    public static class Type implements RecipeType<KaupenFurnaceRecipe> { public static final Type INSTANCE = new Type(); }
    ...
    public static class Serializer implements RecipeSerializer<KaupenFurnaceRecipe> {
        ...
        public Serializer(int defaultCookingTime) { this.defaultCookingTime = defaultCookingTime; }
